  ...
  return (
    <div className='fixed z-10 bottom-0 border-t mx-auto w-full justify-center items-center flex xl:w-auto xl:relative xl:flex-col gap-10 xl:justify-start bg-white xl:rounded-sm p-4'>
      <div className='xl:flex flex-col max-w-[100px] gap-10  bg-white rounded-lg'>
        <div
          className='cursor-pointer flex items-center justify-center h-10 w-10 rounded-full border border-slate-400 opacity-90 drawing-pen-bg'
          style={{ '--drawing-pen-color': drawingPen.color } as React.CSSProperties}
        >
          <input
            type='color'
      ...
      <div
        ...
        style={{
          backgroundColor: isEraserActive ? '#cbd5e1' : 'transparent',
        }}
